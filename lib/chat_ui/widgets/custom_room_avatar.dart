...
/// Avatar nhóm cho luồng chat thường (giống cấu trúc ChatHub - 3 ảnh xếp chồng),
/// fallback bằng chữ viết tắt trên nền màu theo id (getAvatarColor).
class ChatGroupAvatar extends StatelessWidget {
  ...
  const ChatGroupAvatar(
      {Key? key, this.people, this.size = 50, this.groupName})
      : super(key: key);
