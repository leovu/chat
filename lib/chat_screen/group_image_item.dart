      ...
      onTap: onTap ??
          () {
            Navigator.of(context).push(MaterialPageRoute(
                builder: (context) => DetailGroupImageScreen(
                      people: people,
                      images: images,
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              child: Text(
                '${images?.length ?? 0} '
                '${tabbarIndex == 0 ? AppLocalizations.text(LangKey.photos) : tabbarIndex == 1 ? AppLocalizations.text(LangKey.file) : 'Links'}',
                style: TextStyle(
                    fontSize: 14.0,
