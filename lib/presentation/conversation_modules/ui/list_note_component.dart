    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            children: [
              Expanded(child: Text(note.createdAt ?? "")),
              InkWell(
                onTap: () async {
                  await Navigator.of(context).push(MaterialPageRoute(
                      ...
                      settings:
                          const RouteSettings(name: 'create_note_screen')));
                  widget.refreshFunc();
                },
                child: Container(
              ...
              InkWell(
                onTap: () async {
                  CustomNavigator.showCustomAlertDialog(context, null,
                    ...
                    bool? check = await widget.bloc
                        .deleteNotes(widget.roomData.sId!, note.id!);
